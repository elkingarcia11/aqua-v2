      ...
      <div className="px-6 pb-6 mt-auto">
        ...
        {property.airbnbLink && (
          <a
            ...
            className="book-button airbnb-button block w-full text-white font-medium py-2 px-4 rounded-lg transition-colors text-center"
            style={{ backgroundColor: '#6ca4c4', color: 'white' }}
